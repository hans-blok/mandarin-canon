...
Voer de intent `definieer-concept` uit voor de agent `concept-curator` op basis van onderstaande input en kaders uit grondslagen, beleid, charter en contract.
