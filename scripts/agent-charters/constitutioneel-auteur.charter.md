...
- Geraadpleegde Grondslagen:
  ...
  - `grondslagen/aeo/*`
- Actor:
  - Naam/ID: constitutioneel-auteur
  - Versie: 1.0.0
...
Wanneer de **constitutioneel-auteur** handmatig wordt geïnitieerd (dus niet via een geautomatiseerde pipeline of runner), wordt een logbestand weggeschreven naar:

- **Locatie**: `logs/`
- **Bestandsnaam**: `yyyyddmm.HHmm constitutioneel-auteur.log`  
